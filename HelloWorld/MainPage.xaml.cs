...
namespace HelloWorld
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void greetingOutput_SelectionChanged(object sender, RoutedEventArgs e)
        {

        }

        private void ViewTimeline_Click(object sender, TappedRoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                this.Frame.Navigate(typeof(PhotoPage));
        ...
        private void FavoriteTimelines_Click(object sender, RoutedEventArgs e)
        {
